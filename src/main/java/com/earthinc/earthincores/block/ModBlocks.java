package com.earthinc.earthincores.block;

import com.earthinc.earthincores.EarthIncOres;
import com.earthinc.earthincores.item.ModItemGroup;
import com.earthinc.earthincores.item.ModItems;
...
public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS
            = DeferredRegister.create(ForgeRegistries.BLOCKS, EarthIncOres.MOD_ID);
    ...
    private static <T extends Block> void registerBlockItem(String name, RegistryObject<T> block) {
        ModItems.ITEMS.register(name, () -> new BlockItem(block.get(),
                new Item.Properties().group(ModItemGroup.EARTHINCORES_GROUP)));
    }
